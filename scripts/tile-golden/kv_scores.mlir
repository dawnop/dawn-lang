cuda_tile.module @m {
  entry @kv_scores(%arg0: tile<ptr<f64>>, %arg1: tile<ptr<i8>>, %arg2: tile<ptr<f64>>, %arg3: tile<ptr<f64>>) {
    ...
    %69 = reduce %68 dim=1 identities=[0.0 : f64] : tile<64x32xf64> -> tile<64xf64> (%70: tile<f64>, %71: tile<f64>) {
      %72 = addf %70, %71 rounding<nearest_even> : tile<f64>
      yield %72 : tile<f64>
    }
    %73 = constant <i32: 64> : tile<i32>
    %74 = muli %1, %73 : tile<i32>
    %75 = constant <f64: 0.17677669529663687> : tile<64xf64>
    %76 = mulf %69, %75 rounding<nearest_even> : tile<64xf64>
    %77 = reshape %74 : tile<i32> -> tile<1xi32>
    %78 = broadcast %77 : tile<1xi32> -> tile<64xi32>
    %79 = iota : tile<64xi32>
    %80 = addi %78, %79 : tile<64xi32>
    %81 = reshape %arg3 : tile<ptr<f64>> -> tile<1xptr<f64>>
    %82 = broadcast %81 : tile<1xptr<f64>> -> tile<64xptr<f64>>
    %83 = offset %82, %80 : tile<64xptr<f64>>, tile<64xi32> -> tile<64xptr<f64>>
    %84 = store_ptr_tko weak %83, %76 token=%60 : tile<64xptr<f64>>, tile<64xf64> -> token
    return
  }
}
