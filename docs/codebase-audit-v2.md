...
> 并计入其后在当前 main 收口的 TOOL-04；它不重写、重判或重新计数原审计的严重度、
...
- 工具链（10）：`TOOL-01`、`TOOL-02`、`TOOL-04`、`TOOL-09`、`TOOL-11`、`TOOL-12`、
...
- 架构（7）：`ARC-06`–`ARC-12`。
- 工具链（7）：`TOOL-03`、`TOOL-05`–`TOOL-08`、`TOOL-10`、`TOOL-13`。
...
计数自检：**33 已修 + 4 部分 + 60 开放 = 97**；六专题分别覆盖
