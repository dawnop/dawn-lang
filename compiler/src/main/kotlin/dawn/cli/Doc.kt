...
val BUILTIN_GROUPS: List<Pair<String, List<Pair<String, String>>>> = listOf(
    ...
    "list" to listOf(
        ...
        "find" to "the first element satisfying a predicate; None when none match",
        "take" to "a copy of the first n elements (clamped to the length)",
        "drop" to "a copy without the first n elements (clamped to the length)",
        "reverse" to "a reversed copy (the input is not mutated)",
    ),
    "string" to listOf(
