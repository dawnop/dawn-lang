...
public final class BodyProbe {
    ...
    private static void checkReadObservation(Class<?> probe) throws Exception {
        ...
        if ((Long) count.invoke(null, trials) != 50) throw new AssertionError("Unexpected function read trial count");
        for (long i = 0; i < 50; i++) {
        ...
        System.out.println("function-reads\t50\tobservation preserves complete cold Cx and module products");
    }
