cuda_tile.module @m {
  entry @llama_ffn(%arg0: tile<ptr<f64>>, %arg1: tile<ptr<f64>>, %arg2: tile<ptr<f64>>) {
    %0 = make_token : token
    ...
    %8, %9 = for %10 in (%4 to %5, step %6) : tile<i32> iter_values(%11 = %7, %12 = %0) -> (tile<64x32xf64>, token) {
      ...
      %20 = constant <i32: 128> : tile<64x32xi32>
      ...
      %46 = constant <i32: 128> : tile<32x32xi32>
    ...
    %62 = constant <i32: 64> : tile<64x32xi32>
    ...
    %72 = store_ptr_tko weak %71, %8 token=%9 : tile<64x32xptr<f64>>, tile<64x32xf64> -> token
    return
  }
}
