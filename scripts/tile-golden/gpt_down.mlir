cuda_tile.module @m {
  entry @gpt_down(%arg0: tile<ptr<f64>>, %arg1: tile<ptr<f64>>, %arg2: tile<ptr<f64>>, %arg3: tile<ptr<f64>>) {
    %0 = make_token : token
    ...
    %8, %9 = for %10 in (%4 to %5, step %6) : tile<i32> iter_values(%11 = %7, %12 = %0) -> (tile<64x32xf64>, token) {
      ...
      %42 = constant <i32: 64> : tile<32x32xi32>
    ...
    %82 = constant <i32: 64> : tile<64x32xi32>
