cuda_tile.module @m {
  entry @attn_bwd_mmt(%arg0: tile<ptr<f64>>, %arg1: tile<ptr<f64>>, %arg2: tile<ptr<f64>>) {
    ...
    %8, %9 = for %10 in (%5 to %6, step %7) : tile<i32> iter_values(%11 = %4, %12 = %0) -> (tile<32x32xf64>, token) {
      ...
      %24 = iota : tile<32xi32>
      %25 = reshape %24 : tile<32xi32> -> tile<1x32xi32>
      %26 = broadcast %25 : tile<1x32xi32> -> tile<32x32xi32>
      %27 = constant <i32: 64> : tile<32x32xi32>
      %28 = muli %26, %27 : tile<32x32xi32>
      %29 = addi %23, %28 : tile<32x32xi32>
