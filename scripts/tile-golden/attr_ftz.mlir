cuda_tile.module @m {
  entry @attr_ftz(%arg0: tile<ptr<f64>>, %arg1: tile<ptr<f64>>, %arg2: tile<ptr<f64>>) {
    ...
    %24 = addf %17, %23 rounding<nearest_even> : tile<128xf32>
    ...
    %36 = addf %17, %23 rounding<nearest_even> flush_to_zero : tile<128xf32>
    ...
    %48 = mulf %17, %23 rounding<nearest_even> : tile<128xf32>
    ...
    %60 = mulf %17, %23 rounding<nearest_even> flush_to_zero : tile<128xf32>
