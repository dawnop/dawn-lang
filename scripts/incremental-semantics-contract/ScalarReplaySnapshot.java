...
public final class ScalarReplaySnapshot {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (length != 34) throw new AssertionError("Expected 34 replay pairs, got " + length);
        ...
        System.out.println("PASS: scalar full products, 34 pairs and independent body entry counts");
    }
}
