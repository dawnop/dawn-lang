cuda_tile.module @m {
  entry @attn_window(%arg0: tile<ptr<f64>>, %arg1: tile<ptr<f64>>, %arg2: tile<ptr<f64>>) {
    %0 = make_token : token
    ...
    %78 = absi %77 : tile<32x32xi32>
    %79 = constant <i32: 9> : tile<32x32xi32>
    %80 = cmpi less_than %78, %79, signed : tile<32x32xi32> -> tile<32x32xi1>
    %81 = constant <f64: -Infinity> : tile<32x32xf64>
    %82 = select %80, %48, %81 : tile<32x32xi1>, tile<32x32xf64>
    %83 = constant <i32: 2048> : tile<i32>
    %84 = muli %1, %83 : tile<i32>
    %85 = constant <i32: 32> : tile<i32>
    %86 = muli %5, %85 : tile<i32>
    %87 = addi %84, %86 : tile<i32>
    %88 = reshape %87 : tile<i32> -> tile<1x1xi32>
    %89 = broadcast %88 : tile<1x1xi32> -> tile<32x32xi32>
    %90 = iota : tile<32xi32>
    %91 = reshape %90 : tile<32xi32> -> tile<32x1xi32>
    %92 = broadcast %91 : tile<32x1xi32> -> tile<32x32xi32>
    %93 = constant <i32: 64> : tile<32x32xi32>
    %94 = muli %92, %93 : tile<32x32xi32>
    %95 = addi %89, %94 : tile<32x32xi32>
    %96 = iota : tile<32xi32>
    %97 = reshape %96 : tile<32xi32> -> tile<1x32xi32>
    %98 = broadcast %97 : tile<1x32xi32> -> tile<32x32xi32>
    %99 = addi %95, %98 : tile<32x32xi32>
    %100 = reshape %arg2 : tile<ptr<f64>> -> tile<1x1xptr<f64>>
    %101 = broadcast %100 : tile<1x1xptr<f64>> -> tile<32x32xptr<f64>>
    %102 = offset %101, %99 : tile<32x32xptr<f64>>, tile<32x32xi32> -> tile<32x32xptr<f64>>
    %103 = store_ptr_tko weak %102, %82 token=%44 : tile<32x32xptr<f64>>, tile<32x32xf64> -> token
    return
  }
}
