...
| Phase 4 Perceus | **刀 1–3 完成(2026-07-29)**:运行时 ABI、所有权推断 pass(`rc.dawn`)、emitc 消费两个节点。语料 23 个程序全绿并新增 AddressSanitizer 一档;整编译器前端 native 跑通,`checker.dawn` 峰值 4.4 GB → 1.42 GB。剩 2b(最后使用分析)与 4(复用分析),见 [`perceus-design.md`](perceus-design.md) |
