...
public final class ScalarReplaySnapshot {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (length != 16) throw new AssertionError("Expected 16 replay pairs, got " + length);
        ...
        System.out.println("PASS: scalar full products, 16 pairs and independent body entry counts");
    }
}
