cuda_tile.module @m {
  entry @hint_memory(%arg0: tile<ptr<f64>>, %arg1: tile<ptr<f64>>, %arg2: tile<ptr<f64>>) {
    %0 = make_token : token
    ...
    %13, %14 = load_ptr_tko weak %12 token=%0 optimization_hints=<sm_86 = {latency = 4}> : tile<128xptr<f64>> -> tile<128xf64>, token
    ...
    %24 = store_ptr_tko weak %23, %20 token=%19 optimization_hints=<sm_86 = {latency = 7}> : tile<128xptr<f64>>, tile<128xf64> -> token
    return
  }
}
