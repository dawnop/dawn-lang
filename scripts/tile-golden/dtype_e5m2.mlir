cuda_tile.module @m {
  entry @dtype_e5m2(%arg0: tile<ptr<f8E5M2>>, %arg1: tile<ptr<f64>>, %arg2: tile<ptr<f64>>) {
    ...
    %12 = reshape %arg0 : tile<ptr<f8E5M2>> -> tile<1xptr<f8E5M2>>
    %13 = broadcast %12 : tile<1xptr<f8E5M2>> -> tile<128xptr<f8E5M2>>
    %14 = offset %13, %11 : tile<128xptr<f8E5M2>>, tile<128xi32> -> tile<128xptr<f8E5M2>>
    %15, %16 = load_ptr_tko weak %14 token=%0 : tile<128xptr<f8E5M2>> -> tile<128xf8E5M2>, token
    %17 = ftof %15 rounding<nearest_even> : tile<128xf8E5M2> -> tile<128xf64>
    ...
    %33 = ftof %31 rounding<nearest_even> : tile<128xf64> -> tile<128xf8E5M2>
    %34 = ftof %33 rounding<nearest_even> : tile<128xf8E5M2> -> tile<128xf64>
