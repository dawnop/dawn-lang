...
/** Version and commit of this build, from the resource generated by :compiler:generateBuildInfo. */
object BuildInfo {
    private val props =
        java.util.Properties().apply {
            BuildInfo::class.java.getResourceAsStream("/dawn-build.properties")?.use { load(it) }
        }

    val version: String get() = props.getProperty("version") ?: "unknown"
    val commit: String get() = props.getProperty("commit") ?: "unknown"

    override fun toString() = "dawn $version ($commit)"
}
