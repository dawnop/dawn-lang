cuda_tile.module @m {
  entry @matmul_f16(%arg0: tile<ptr<f16>>, %arg1: tile<ptr<f16>>, %arg2: tile<ptr<f16>>) {
    %0 = make_token : token
    ...
    %11 = constant <f16: 0.0> : tile<32x32xf16>
    %12 = constant <i32: 0> : tile<i32>
    %13 = constant <i32: 2> : tile<i32>
    %14 = constant <i32: 1> : tile<i32>
    %15, %16 = for %17 in (%12 to %13, step %14) : tile<i32> iter_values(%18 = %11, %19 = %0) -> (tile<32x32xf16>, token) {
      ...
      %35 = reshape %arg0 : tile<ptr<f16>> -> tile<1x1xptr<f16>>
      %36 = broadcast %35 : tile<1x1xptr<f16>> -> tile<32x32xptr<f16>>
      %37 = offset %36, %34 : tile<32x32xptr<f16>>, tile<32x32xi32> -> tile<32x32xptr<f16>>
      %38, %39 = load_ptr_tko weak %37 token=%19 : tile<32x32xptr<f16>> -> tile<32x32xf16>, token
      ...
      %55 = reshape %arg1 : tile<ptr<f16>> -> tile<1x1xptr<f16>>
      %56 = broadcast %55 : tile<1x1xptr<f16>> -> tile<32x32xptr<f16>>
      %57 = offset %56, %54 : tile<32x32xptr<f16>>, tile<32x32xi32> -> tile<32x32xptr<f16>>
      %58, %59 = load_ptr_tko weak %57 token=%39 : tile<32x32xptr<f16>> -> tile<32x32xf16>, token
      %60 = mmaf %38, %58, %18 : tile<32x32xf16>, tile<32x32xf16>, tile<32x32xf16>
      continue %60, %59 : tile<32x32xf16>, token
    }
    ...
    %76 = reshape %arg2 : tile<ptr<f16>> -> tile<1x1xptr<f16>>
    %77 = broadcast %76 : tile<1x1xptr<f16>> -> tile<32x32xptr<f16>>
    %78 = offset %77, %75 : tile<32x32xptr<f16>>, tile<32x32xi32> -> tile<32x32xptr<f16>>
    %79 = store_ptr_tko weak %78, %15 token=%16 : tile<32x32xptr<f16>>, tile<32x32xf16> -> token
    return
  }
}
