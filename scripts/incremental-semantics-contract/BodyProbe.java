...
public final class BodyProbe {
    ...
    private static void checkReadObservation(Class<?> probe) throws Exception {
        ...
        if ((Long) count.invoke(null, trials) != 44) throw new AssertionError("Unexpected function read trial count");
        for (long i = 0; i < 44; i++) {
        ...
        System.out.println("function-reads\t44\tobservation preserves complete cold Cx and module products");
    }
