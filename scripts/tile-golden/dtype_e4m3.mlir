cuda_tile.module @m {
  entry @dtype_e4m3(%arg0: tile<ptr<f8E4M3FN>>, %arg1: tile<ptr<f64>>, %arg2: tile<ptr<f64>>) {
    %0 = make_token : token
    ...
    %12 = reshape %arg0 : tile<ptr<f8E4M3FN>> -> tile<1xptr<f8E4M3FN>>
    %13 = broadcast %12 : tile<1xptr<f8E4M3FN>> -> tile<128xptr<f8E4M3FN>>
    %14 = offset %13, %11 : tile<128xptr<f8E4M3FN>>, tile<128xi32> -> tile<128xptr<f8E4M3FN>>
    %15, %16 = load_ptr_tko weak %14 token=%0 : tile<128xptr<f8E4M3FN>> -> tile<128xf8E4M3FN>, token
    %17 = ftof %15 rounding<nearest_even> : tile<128xf8E4M3FN> -> tile<128xf64>
    ...
    %33 = ftof %31 rounding<nearest_even> : tile<128xf64> -> tile<128xf8E4M3FN>
    %34 = ftof %33 rounding<nearest_even> : tile<128xf8E4M3FN> -> tile<128xf64>
