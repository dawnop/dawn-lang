...
def main():
    ...
    variants = [
        ...
        ("function-read-domain", "semantic_reads.project(p.function_reads, s => relocate.signature(v.ids, s),\n      t => relocate.ty(v.ids, t), id => relocate.nominal(v.ids, id))?", "p.function_reads"),
